    ...
    return (
      <div>
        ...
        <>
          ...
          <ReactGlobe
            globeOptions={{
              backgroundTexture: `https://raw.githubusercontent.com/chrisrzhou/react-globe/main/textures/${background}`,
              cloudsTexture: `https://raw.githubusercontent.com/chrisrzhou/react-globe/main/textures/${clouds}`,
              texture: `https://raw.githubusercontent.com/chrisrzhou/react-globe/main/textures/${globe}`,
            }}
